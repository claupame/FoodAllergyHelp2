...
public class IntoleranciasAdapter extends BaseAdapter {
    private Context context;
    public static List<UsuarioAlergiasObject> items;
   // UsuarioAlergiasObject item;


    public IntoleranciasAdapter(Context context, List<UsuarioAlergiasObject> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_ingredient2, null, true);
