...
public  class LanguageSelectionAdapter2 extends BaseAdapter {

    private IdiomaObject[] mLangs;


    public LanguageSelectionAdapter2(Context context) {

        Resources resources = context.getResources();

        String[] codes = resources.getStringArray(R.array.idioma_cod_arrays_2);
        String[] names = resources.getStringArray(R.array.idioma_nombre_arrays_2);
